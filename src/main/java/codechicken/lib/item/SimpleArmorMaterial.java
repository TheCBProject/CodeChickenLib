...
public class SimpleArmorMaterial implements IArmorMaterial {
    ...
    public SimpleArmorMaterial(int[] durability, int[] damageReduction, int enchantability, SoundEvent soundEvent, Supplier<Ingredient> repairMaterial, String textureName, float toughness) {
    ...
    public static class Builder {
        ...
        public SimpleArmorMaterial build() {
            return new SimpleArmorMaterial(durability, damageReduction, enchantability, soundEvent, repairMaterial, textureName, toughness);
        }
    }
}
