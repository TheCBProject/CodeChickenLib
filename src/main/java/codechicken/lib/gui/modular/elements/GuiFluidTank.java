...
//    public static final SpriteSupplier DEFAULT_WINDOW = GuiTextures.CCL.get("widgets/tank_window");
//
//    private int gaugeColour = 0xFF909090;
//    private boolean drawGauge = true;
//    private SpriteSupplier window = SpriteSupplier.EMPTY;
...
//
//    public GuiFluidTank(GuiParent<?> parent) {
//        super(parent);
//        setTooltipDelay(0);
...
//     */
//    public static FluidTank simpleTank(GuiParent<?> parent) {
...
//     */
//    public GuiFluidTank setWindow(SpriteSupplier window) {
//        this.window = window;
//        return this;
//    }
//
...
//        var fluidStill = getStillTexture(stack);
//
//        if (!stack.isEmpty() && fluidStill != null) {
//            int fluidColor = getColour(stack);
//            float height = getCapacity() <= 0 ? 0 : (float) ySize() * (stack.getAmount() / (float) getCapacity());
//            graphics.tileSprite(fluidStill.renderType(GuiRender::texColType), xMin(), yMax() - height, xMax(), yMax(), fluidStill, fluidColor);
//        }
//        window.ifPresent(icon -> {
//            graphics.tileSprite(window.renderType(GuiRender::texColType), xMin(), yMin(), xMax(), yMax(), icon, 0xFFFFFFFF);
//        });
//
...
//                graphics.cc$fill(xMax() - width, yPos, xMax(), yPos + 1, gaugeColour);
//                pos += spacing;
//            }
//        }
//    }
...
//                        .withStyle(GOLD)
//                        .append(" ")
//                        .append(fluidStack.getHoverName().copy()
...
//        return Minecraft.getInstance().getAtlasManager().get(ClientHooks.getBlockMaterial(texture));
//    }
//
//    @Nullable
