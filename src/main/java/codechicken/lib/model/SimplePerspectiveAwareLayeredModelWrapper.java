...
public class SimplePerspectiveAwareLayeredModelWrapper implements IPerspectiveAwareModel {
    ...
    public SimplePerspectiveAwareLayeredModelWrapper(Map<BlockRenderLayer, IBakedModel> layerModelMap, Map<TransformType, TRSRTransformation> cameraTransforms, BakedModelProperties properties) {
